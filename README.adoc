...
== Cellular IoT
EMnify is a IoT communications platform that enables you to connect your IoT solutions anywhere with the EMnify Global IoT SIM. Not only do you get global cellular access but with our cloud-native platform, we provide you with network meta-data to manage, monitor, and secure device communication.

- IoT SIM

Using a single SIM, you can have multiple IMSIs, switch between multiple carriers and ensure uninterrupted connectivity.

- Network redundancy

With our own *Home network* deployed to the cloud in multiple availability zones, device communication remain uninterrupted.

- Cloud Integration

Given the cloud-native nature of our platform, you can easily integrate network meta-data to cloud-services of your choice and automate processes like activation, quota management, billing and many more.

- EMnify API

With the EMnify API, you can integrate all our services and features into your own applications using HTTP requests.  
...
== Quickstart
To begin your developing your IoT solutions with EMnify, you will need an EMnify account. link:https://portal.emnify.com/sign/up?utm_source=dev-hub[Sign up]  for free for your EMnify account.

=== Ordering SIMs
Before you begin the production of your IoT solution  with your EMnify SIM cards, you may want to test the service. You can order an Evaluation Pack directly on the EMnify portal. 
...
// You can also get it by scanning the SIM.
+ 
image::BIC.png[width=500, float="center"]
...
After you activate a SIM, it is also necessary to assign a device to it. This makes it easier to address the 
