...
image::Android_01_Settings.jpg[]

2. Go to Mobile data 

image::Android_02_Mobile_Network.jpg[]

3. Enable roaming and go to Access Point Names (APN)

image::Android_03_Mobile_Data.jpg[]

4. Create a new APN with any name and configure the APN with "em"

image::assets/Android_04_Create_Access_Point_name.jpg[]
image::Android_05_Configure_APN[]
